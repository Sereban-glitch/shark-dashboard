...
// ProcessInfo holds information about a Supervisord-managed process.
type ProcessInfo struct {
	Name        string `json:"name"`
	Group       string `json:"group"`
	PID         int    `json:"pid"`
	State       int    `json:"state"`       // 0=STOPPED, 10=STARTING, 20=RUNNING, 30=BACKOFF, 40=STOPPING, 100=EXITED, 200=FATAL
...
// StateNameMap maps Supervisord state codes to human-readable names.
